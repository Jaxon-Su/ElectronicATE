...
class CenterComboDelegate : public QStyledItemDelegate {
public:
...
void applyComboBoxStyle(QComboBox *cb, bool headerLook)
{
    ...
    if (!dynamic_cast<CenterComboDelegate*>(cb->itemDelegate()))
        cb->setItemDelegate(new CenterComboDelegate(cb));
#if QT_VERSION >= QT_VERSION_CHECK(6, 9, 0)
    cb->setLabelDrawingMode(QComboBox::LabelDrawingMode::UseDelegate);
#endif
