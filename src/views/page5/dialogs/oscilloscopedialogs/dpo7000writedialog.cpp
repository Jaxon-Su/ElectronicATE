...
//  Constructor
// ══════════════════════════════════════════════════════
DPO7000WriteDialog::DPO7000WriteDialog(Oscilloscope*      scope,
...
{
    buildFrame({680, 600}, true);
}

// ══════════════════════════════════════════════════════
//  buildContentWidget — DPO7000 完整設定 UI
// ══════════════════════════════════════════════════════
QWidget* DPO7000WriteDialog::buildContentWidget()
{
    ...
    // ★ 直接 addRow spinbox，不用 container 包裝
    //   container 會攔截 mouse event 導致箭頭點不到
...
// ══════════════════════════════════════════════════════
void DPO7000WriteDialog::saveConfig()
{
    if (!m_timescale) return;   // buildContentWidget 尚未呼叫（防呆）
